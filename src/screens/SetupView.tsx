...
<div className={`p-10 rounded-[4rem] border-2 transition-all duration-500 ${isBuzzerConnected ? 'bg-slate-900 border-emerald-500 shadow-[0_0_50px_rgba(16,185,129,0.15)]' : 'bg-slate-900/30 border-slate-800 grayscale'}`}>
  ...
  <div className="grid grid-cols-1 gap-6"> 
    {[1, 2, 3].map((slotNumber) => {
      const assignedPlayer = isBuzzerConnected ? players.find(p => p.id === slotNumber) : null;
      ...
      return ( 
        <div key={slotNumber} className="flex gap-6 items-end">
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className={`border-2 rounded-[2rem] px-10 h-[84px] flex items-center transition-all duration-300 ${
              assignedPlayer 
          ...
          <div className="flex flex-col items-center">
            ...
            <input
              ...
              className={`w-32 h-[84px] border-2 rounded-[2rem] px-2 font-black text-3xl text-center outline-none transition-all ${
                assignedPlayer 
