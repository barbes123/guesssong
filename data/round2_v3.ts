  ...
  const R2321 = audioUrl('tri-belyh-konya--minus', '/music/round2/tri-belyh-konya--minus.mp3');
  const R2321f = audioUrl('tri-belyh-konya', '/music/round2/tri-belyh-konya.mp3');
  ...
  const R2323 = audioUrl('sneg-kruzhit-sneg-kruzhitsya_minus', '/music/round2/sneg-kruzhit-sneg-kruzhitsya_minus.mp3');
  const R2323f = audioUrl('sneg-kruzhit-sneg-kruzhitsya', '/music/round2/sneg-kruzhit-sneg-kruzhitsya.mp3');
  ...
  const R2333 = audioUrl('Irina_Otieva_-_Poslednyaya_poema_iz_k_f_Vam_i_ne_snilos_ minus', '/music/round2/Irina_Otieva_-_Poslednyaya_poema_iz_k_f_Vam_i_ne_snilos_ minus.mp3.mp3');
  ...
  export const round2v3Set: RoundSet = {
    id: 'round2_v3',
    name: { en: 'round2_v3', ru: 'round2_v3' },
    author: 'DT',
    version: '1.0',
    data: [
      {
        ...
        songs: [
          {
            ...
            audioUrl: R2321,
            audioUrlFull: R2321f,
            notes: 'Главный зимний хит советского кино, который знают от мала до велика. Три белых коня — декабрь, январь и февраль — мчат нас сквозь сказку, даря ощущение чуда и приближающегося праздника. «И уносят меня, и уносят меня / В звенящую снежную даль / Три белых коня, эх, три белых коня — / Декабрь, январь и февраль!» «Остыли реки, и земля остыла, / И чуть нахохлились дома. / Это в городе тепло и сыро, / Это в городе тепло и сыро, / А за городом — зима, зима, зима!»'
          },
          {
            id: 'r23_q6',
          ...
          },
          {
            ...
            audioUrl: R2323,
            audioUrlFull: R2323f,
            notes: 'Неотъемлемая часть главного новогоднего фильма страны. Эта мелодия для миллионов зрителей — запах мандаринов, хруст ёлочных игрушек и предчувствие чего-то очень личного и важного в самый волшебный вечер года. «Снег кружится, летает, летает, / И, позёмкою взвиваясь, / Белым снегом укрывает... / Всю землю, как ковром, белым снежным серебром!» «Мне такая ночь только раз даётся, / Не беда, что снег за окном метётся...»'
          },
          {
            id: 'r23_q8',
            title: 'Айсберг',
