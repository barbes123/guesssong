...
const R5R12minus = audioUrl('sneg-kruzhitsya-minus_v5xkti', '/music/round4/sneg-kruzhitsya-minus_v5xkti.mp3');
const R5R12full  = audioUrl('sneg-kruzhitsya_xcm1ww', '/music/round4/sneg-kruzhitsya_xcm1ww.mp3');

const R5R13minus = audioUrl('spi-moya-radost-usni-minus_twfybb', '/music/round4/spi-moya-radost-usni-minus_twfybb.mp3');
const R5R13full  = audioUrl('spi-moya-radost-usni_syg4kr', '/music/round4/spi-moya-radost-usni_syg4kr.mp3');
